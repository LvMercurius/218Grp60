...
data_arg.add_argument('--city_num', type=int, default=30, help='city num')
data_arg.add_argument('--pos_dimension', type=int, default=2, help='city position') # coordinate

data_arg.add_argument('--gen_num', type=int, default=500, help='generation num') # iteration

# Genetic Algo Data
data_arg.add_argument('--individual_num', type=int, default=100, help='individual num')
data_arg.add_argument('--mutate_prob', type=float, default=0.08, help='probability of mutate') # mutation prob

# Ant Colony Algo Data
data_arg.add_argument('--ant_num', type=int, default=25, help='number of ants')
...
data_arg.add_argument('--cooling_rate', type=float, default=0.97, help='cooling rate (temperature decay factor per iteration)')
